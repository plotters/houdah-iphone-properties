...
- (id)init
{
	if ((self = [super initWithContainer:[NSUserDefaults standardUserDefaults]
							 descriptors:[UserDefaultsViewController propertyDescriptors]]) != nil) {
	}
...
+ (NSArray*)propertyDescriptors
{
	...
	if (propertyDescriptors == nil) {
		...
		[sizeProperty setObject:[[[ResolutionFormatter alloc] init] autorelease] forKey:@"formatter"];
